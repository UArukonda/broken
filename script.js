...
//   {
//     title: "I Truly Regret What I Did",
//     text: `I regret it so much, ra. I really do. I wish I could undo it somehow. I prayed to every god, wishing I could go back in time and change what happened. I even had thoughts wishing I could just end my life.

// Yesterday, when I was holding the matchbox to light my birthday candle, I honestly felt like setting myself on fire. When I was crying, I even tried banging my head against the wall.

// You don’t even want to see me now, and that pain makes me feel like hurting myself. But I swear to you, I would never ever do something like this again, ra. Please trust me one more time… just one last time.

// I will never hurt you like this again in my life. Punish me for my mistake if you want. I am already suffering a lot, but I will accept whatever punishment you give me. I just beg you… please don’t leave me.`,
//   },
//   { title: "Call me", text: "please for once" },
// ];
...
function updateCard() {
  ...
  nextBtn.style.display =
    currentIndex === thoughts.length - 1 ? "none" : "block";
}
...
function handleSwipe() {
  ...
  if (distance > 50 && currentIndex < thoughts.length - 1) {
    changeCard(1);
  }
